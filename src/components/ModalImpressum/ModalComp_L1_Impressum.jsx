...
const ModalComp_L1_Impressum = ({ colors, content, mq, isAuthenticated }) => {
  const debug = false;

  if (debug) console.log('ModalComp_L1_Impressum: ');
  ...
  return (
    <div className="modal-col">
      ...
      <div className="impressum scroll_">
        ...
        <p>
          Alle hier verwendeten Namen, Begriffe, Zeichen und Grafiken können Marken- oder Warenzeichen im
          Besitze ihrer rechtlichen Eigentümer sein. Die Rechte aller erwähnten und benutzten Marken- und
          Warenzeichen liegen ausschließlich bei deren Besitzern.
        </p>
        <p>
          Insbesondere sind die Logos des internationalen „Budo Forschungszentrum Tengu Institut“
...
export default ModalComp_L1_Impressum;
